...
import Table from 'src/sponsors/screens/Table'
import { useRouter } from 'next/router'
import { useHash } from 'layout/HashRoutes'

const _uid = 'all-sponsors-table'
...
const mapStateToProps = (state, { uid = _uid }) => {
  return { page: sponsorsDuck.selectors.find(state, { uid }) }
}

const mapDispatchToProps = {
  find: sponsorsDuck.creators.find
}
